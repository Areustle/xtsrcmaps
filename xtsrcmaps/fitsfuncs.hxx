...
auto ccube_energies(std::string const&) noexcept -> std::optional<std::vector<double>>;
...
auto ccube_pixels(std::string const&) noexcept -> std::optional<CCubePixels>;
...
auto read_irf_pars(std::string const&, std::string const&) -> std::optional<TablePars>;
