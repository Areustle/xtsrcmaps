...
//     double const& stail = pars[3]; //* scaleFactor(energy) }; // pars by
//     scaleFactor(IE) double const& gcore = pars[4]; // assured not to be 1.0 double
//     const& gtail = pars[5]; // assured not to be 1.0
//
//     double rc           = sep / score;
//     double uc           = rc * rc / 2.;
//
