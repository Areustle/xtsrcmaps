 ...
 **/
auto pixel_grid_centers(long const Nh, long const Nw) -> Tensor3d;

/**
 * Return the points which make up the 4 point corners of all pixels in 3-vector
 * cartesian coordinates (dir / xyz).
 **/
auto pixel_grid_vertices(long const Nh, long const Nw, Fermi::SkyGeom const& skygeom)
    -> Tensor3d;
 ...
 **/
auto pixel_grid_normals(Tensor3d const& vertices) -> std::pair<Tensor2d, Tensor2d>;
